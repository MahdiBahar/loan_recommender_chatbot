...
class Chat():
    ...
    def prompt_rag(self, context, query):
        ...
        "2. غیر از احوال‌پرسی:\n"
        "   - اگر محتوا اطلاعات کافی برای پاسخ دارد، حداقل یک جمله و حداکثر در چهار جمله پاسخ بدهید. "
        "نکته خیلی خیلی مهم: پس از اینکه محتوا استخراج شد، به هیچ عنوان هیچ خروجی اضافه دیگری مثل <متأسفم، اطلاعات کافی برای پاسخگویی موجود نیست> نشان ندهید.\n\n"
